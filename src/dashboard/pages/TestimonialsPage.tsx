      ...
      <div className={`section-toggle-banner ${sectionEnabled ? 'is-enabled' : 'is-disabled'}`}>
        <div className="banner-left">
          <div className="toggle-icon-wrap">
            <Icon icon={sectionEnabled ? 'lucide:layout' : 'lucide:layout-template'} width={22} height={22} />
          </div>
          <div>
            <div className="banner-title-row">
              <h4>Public Portfolio Testimonials Section</h4>
            ...
            <p className="banner-desc">
              {sectionEnabled
                ? 'The Testimonials carousel is currently active and scrolling live on your homepage.'
                : 'The Testimonials section is completely hidden from your public portfolio.'}
            </p>
          </div>
        </div>
        {onToggleSectionEnabled && (
